...
/**
 * CTA Thin Cap – title, subtitle, social links from theme, image from build (cap.webp).
 */
class CtaThinCap extends \Opencart\System\Engine\Controller {
	...
	public function index(array $setting): string {
		...
		$data['image_src'] = $base . '/extension/termopab/catalog/view/image/cap.webp';

		$this->template->addPath('extension/termopab', DIR_EXTENSION . 'termopab/catalog/view/template/');
		return $this->load->view('extension/termopab/module/cta_thin_cap', $data);
	}
}
