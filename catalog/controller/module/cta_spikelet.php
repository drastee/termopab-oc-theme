...
/**
 * CTA Spikelet – form with title (first line + rest in span), intro, socials, image.
 */
class CtaSpikelet extends \Opencart\System\Engine\Controller {
	public function index(array $setting): string {
		...
		$data['image_desktop'] = $view_base . 'image/welder-spikelet.webp';
		$data['image_mobile'] = $view_base . 'image/welder-spikelet-mob.webp';
		$data['video_explosion'] = $view_base . 'image/explosion.webm';

		$data['form_id'] = 'cta-spikelet-form';

		$this->template->addPath('extension/termopab', DIR_EXTENSION . 'termopab/catalog/view/template/');
		return $this->load->view('extension/termopab/module/cta_spikelet', $data);
	}
}
