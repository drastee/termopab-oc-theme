<?php
$_['heading_title']    = 'CTA Spikelet (Termopab)';

$_['text_extension']   = 'Розширення';
$_['text_success']     = 'Успіх: Модуль CTA Spikelet змінено!';
$_['text_edit']        = 'Редагувати модуль CTA Spikelet';
...
$_['help_title_lines'] = 'Перший рядок — звичайний текст, наступні — у тезі &lt;span&gt; (з нового рядка кожен).';
$_['help_socials']     = 'Оберіть, які соцмережі показувати. Посилання задаються в налаштуваннях теми (Design → Theme Termopab).';

$_['button_save']      = 'Зберегти';
$_['button_back']      = 'Назад';

$_['error_permission'] = 'Увага: Немає прав для зміни модуля CTA Spikelet!';
